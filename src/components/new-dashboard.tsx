...
const SIHInfoItem = ({ info }: { info: any }) => {
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Card className="card-hover bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 backdrop-blur-md border-primary/20 overflow-hidden group transition-all duration-300 hover:shadow-lg hover:border-primary/30 cursor-pointer">
            ...
            <DialogContent className="w-[95%] max-w-[95vw] md:max-w-3xl lg:max-w-4xl h-[80vh] flex flex-col p-0 border-0 overflow-hidden rounded-lg">
                ...
                <div className="p-6 flex flex-col flex-1 min-h-0">
                    <DialogHeader className="flex-shrink-0">
                        ...
                        <DialogDescription>
                            Posted on {format(new Date(info.created_at), 'eeee, MMMM d, yyyy')}
                        </DialogDescription>
                    </DialogHeader>
                    <div className="flex-1 mt-4 relative">
                        <ScrollArea className="absolute inset-0 -mr-6 pr-6">
